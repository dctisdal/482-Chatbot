...
class SentimentAnalyzer:
    ...
    def sentiment(self, sent):
        ...
        # not really a great way of handling compounds beyond just seeing which of the
        # other categories fits it best, so we can just pop it off and take the max of the others
        scores.pop("compound")
        highest = max(scores, key=scores.get)
        print("Judged to be", highest)
        return highest
